...
// Mode "live2d": the files of a Live2D model site entry (Live2DModel.cs); ApkData is the APK data directory (ApkData.cs).
public sealed record WorkerJob(Config Config, Location Target, WorkerInput[] Inputs, string Output, int ParentPid = 0, string? Mode = null, string? ApkData = null);
